...
export default function Home(props: any) {
  ...
  const [isCreateMessageOpen, setIsCreateMessageOpen] =
    useState<boolean>(false);
  ...
  const handleSearch = async (data: any) => {
    ...
    let searchTaskList: any = await taskApiFunction?.readTasks(
      data?.length > 0 ? filter : { IsDeleted: false }
    );
  ...
  return (
    <>
      ...
      <Drawer anchor="right" open={isTaskFormOpen}>
        <TaskForm
          configs={{
            datatestID: "",
          }}
      ...
      <div style={{ height: "70vh", overflowY: "scroll" }}>
        {isTaskListLoading ? (
          ...
          <TaskList
            ...
            callbacks={{
              handleTaskEdit: (data: any) => {
                setIsTaskFormOpen(true),
                  setIsEditFormOpen(true),
                  setEditTaskData(data);
              },
              handleTaskDelete: (data: any) => {
                setIsDeletePopUpVisible(true);
                setDeleteTaskRecord(data);
              },
            }}
          />
        )}
      ...
      {isDeletePopUpVisible && (
        <Dialog open={isDeletePopUpVisible} keepMounted>
          <DialogContent>
            <DialogContentText>
